...
public abstract class GCEditor<T extends GCEntity>
        extends GCChangeHandler {

    /**
     * 
     */
    private static final long serialVersionUID = 594805889307400074L;
    ...
    public GCEditor(JpaRepository<T, Long> repositoryDao, Binder<T> binder) {
